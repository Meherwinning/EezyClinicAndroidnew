...
import com.vempower.eezyclinic.fragments.FeedbackFragment;
import com.vempower.eezyclinic.fragments.NewHomeFragment;
import com.vempower.eezyclinic.utils.Utils;

public class FeedbackActivity extends AbstractMenuActivity {


    public static final int IS_ACTIVITY_REFRESH_REQUEST_CODE = 6395;
    ...
    public void setActionBar() {
        ...
        titleName.setText(Utils.getStringFromResources(R.string.title_activity_feedback_lbl));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        {
            if(requestCode==IS_ACTIVITY_REFRESH_REQUEST_CODE)
            {
                if(fragment!=null)
                {
                    fragment.refresh();
