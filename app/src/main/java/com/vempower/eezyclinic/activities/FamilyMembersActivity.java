...
import com.vempower.eezyclinic.fragments.FamilyMembersListFragment;
import com.vempower.eezyclinic.fragments.MedicalHistoryListFragment;
import com.vempower.eezyclinic.utils.Utils;

public class FamilyMembersActivity extends AbstractMenuActivity {
    ...
    public void setActionBar() {
        ...
        titleName.setText(Utils.getStringFromResources(R.string.title_activity_family_menbers));
    ...
    protected AbstractFragment getFragment() {
        return new FamilyMembersListFragment();
    }
