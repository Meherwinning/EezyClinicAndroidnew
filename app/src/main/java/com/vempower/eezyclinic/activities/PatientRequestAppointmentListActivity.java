...
import com.vempower.eezyclinic.fragments.PatientRequestAppointmentListFragment;
import com.vempower.eezyclinic.utils.Utils;

public class PatientRequestAppointmentListActivity extends AbstractMenuActivity {
    public void setActionBar() {
        ...
        titleName.setText(Utils.getStringFromResources(R.string.title_activity_request_appointments));
    ...
    protected AbstractFragment getFragment() {
        return new PatientRequestAppointmentListFragment();
    }
