...
public class UpcomingFollowupsActivity extends AbstractMenuActivity {
    ...
    public void setActionBar() {
        ...
        titleName.setText(Utils.getStringFromResources(R.string.title_activity_upcoming_followups));
