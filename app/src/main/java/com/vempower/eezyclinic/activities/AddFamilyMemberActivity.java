...
import com.vempower.eezyclinic.fragments.AddFamilyMemberFragment;
...
public class AddFamilyMemberActivity extends AbstractMenuActivity {
    ...
    public void setActionBar() {
        ...
        titleName.setText(Utils.getStringFromResources(R.string.title_activity_add_family_member));
