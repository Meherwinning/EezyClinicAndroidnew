...
public class AddSecoundaryInsuranceMapper extends AbstractMapper implements Callback<AbstractResponse> {

    private AddSecoundaryInsuranceListener listener;
   // private final File frontImage, backImage;
    //private final String keyName;
    private final SecondaryInsurance insurance;


    public AddSecoundaryInsuranceMapper(SecondaryInsurance insurance) {
    ...
    public void setOnAddSecoundaryInsuranceListener(AddSecoundaryInsuranceListener listener) {
        if (listener == null) {
            Log.i(MyApplication.getCurrentActivityContext().getClass().getName(), "Invalid AddSecoundaryInsuranceListener instance.");
    ...
    private void init() {
        ...
        if (!Utils.isNetworkAvailable(MyApplication
            ...
            if (listener != null) {
                listener.addSecoundaryInsurance(null, Utils.getStringFromResources(R.string.network_not_available_lbl));
            }
            return;
        }
       ...
       /*   RequestBody body=getMyRequestBody();
        ...
        if (insurance==null) {
            if (listener != null) {
                listener.addSecoundaryInsurance(null, null);
            }
            return;
        }
        ...
        Call<AbstractResponse> apiResponseCall = stashDealAPI.addSecondaryInsurance(map);
    ...
    public void onResponse(Response<AbstractResponse> response, Retrofit retrofit) {
        ...
        getMyResponse(response, new MyResponse<AbstractResponse>() {
            ...
            public void getMyResponse(AbstractResponse responseBody, String errorMsg) {
                listener.addSecoundaryInsurance(responseBody, errorMsg);
            }
        });
...
//    }
  ...
  /*
    ...
    public interface AddSecoundaryInsuranceListener {
        public void addSecoundaryInsurance(AbstractResponse PreferencesAPI, String errorMessage);
    }
