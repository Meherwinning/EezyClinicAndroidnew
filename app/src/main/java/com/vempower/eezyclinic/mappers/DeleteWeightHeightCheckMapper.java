...
public class DeleteWeightHeightCheckMapper extends AbstractMapper implements Callback<AbstractResponse> {


    private DeleteWeightHeightCheckListener listener;

    private final int checkupgroupid;

    public DeleteWeightHeightCheckMapper(int checkupgroupid) {
        this.checkupgroupid = checkupgroupid;

    }

    public void setOnDeleteWeightHeightCheckListener(DeleteWeightHeightCheckListener listener) {
        if (listener == null) {
    ...
    private void init() {
        ...
        if (!Utils.isNetworkAvailable(MyApplication
            ...
            if (listener != null) {
                listener.deleteWeightHeight(null, Utils.getStringFromResources(R.string.network_not_available_lbl));
            }
            return;
        }
        ...
        if (requestBody == null) {
            ...
            if (listener != null) {
                listener.deleteWeightHeight(null, null);
            }
            return;
        }
    ...
    public void onResponse(Response<AbstractResponse> response, Retrofit retrofit) {
        ...
        getMyResponse(response, new MyResponse<AbstractResponse>() {
            ...
            public void getMyResponse(AbstractResponse responseBody, String errorMsg) {
                listener.deleteWeightHeight(responseBody, errorMsg);
            }
        });
  ...
  "checkupgroupid":76
    ...
    public interface DeleteWeightHeightCheckListener {
