...
public class UploadHealthRecordsMapper extends AbstractMapper implements Callback<AbstractResponse> {
    ...
    private final String documentType, documentDate, doctorName,  clinicName,  otherDetails  , documentName;


    public UploadHealthRecordsMapper(ArrayList<File> fileList, String documentType,String documentDate,
    ...
    private void init() {
       ...
       // Call<AbstractResponse> apiResponseCall = stashDealAPI.uploadProfileImage(imageBody, mybody);
        Call<AbstractResponse> apiResponseCall = stashDealAPI.uploadHealthRecords(map);
