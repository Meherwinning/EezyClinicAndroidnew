...
public class MyLineMorphingDrawable extends Drawable implements Animatable{
	...
	private MyLineMorphingDrawable(State[] states, int curState, int paddingLeft, int paddingTop, int paddingRight, int paddingBottom, int animDuration, Interpolator interpolator, int strokeSize, int strokeColor, Paint.Cap strokeCap, Paint.Join strokeJoin, boolean clockwise, boolean isRtl){
		mStates = states;
	...
	public static class Builder{
		...
		public MyLineMorphingDrawable build(){
			if(mStrokeCap == null)
			...
			return new MyLineMorphingDrawable(mStates, mCurState, mPaddingLeft, mPaddingTop, mPaddingRight, mPaddingBottom, mAnimDuration, mInterpolator, mStrokeSize, mStrokeColor, mStrokeCap, mStrokeJoin, mClockwise, mIsRtl);
		}
